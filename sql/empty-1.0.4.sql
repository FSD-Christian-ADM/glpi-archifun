...
CREATE TABLE `glpi_plugin_archifun_funcareas` (
  ...
  `plugin_archifun_funcareas_id` INT UNSIGNED NOT NULL DEFAULT '0',
...
CREATE TABLE `glpi_plugin_archifun_funcareas_items` (
	...
	`plugin_archifun_funcareas_id` INT UNSIGNED NOT NULL default '0' COMMENT 'RELATION to glpi_plugin_archifun_funcareas (id)',
